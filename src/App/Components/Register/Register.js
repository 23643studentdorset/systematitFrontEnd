...
const Register = () => {
    ...
    return(
        <Box m={10} sx={{ width: 500, height: 500, backgroundColor: 'textDark', color:"textLight"}}>
            <section>               
                ...
                <form>
                    ...
                    <Box marginTop={2} sx={{alignItems: 'center', textAlign:"center"}}>
                        <Button size="medium" color="textLight" disabled={(!validEmail || !validPassword || !validMatch) ? true : false} onClick={handleSubmit}>Register</Button>
                    </Box>
                </form>
            </section>          
        </Box>
